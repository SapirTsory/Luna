...
const WELCOME_MESSAGES: { title: string; subtitle: string; detail?: string }[] = [
  {
    title: 'לא הכול צריך להיות עלייך.',
    subtitle: 'מהיום יש לך לונה.',
    detail: 'לונה עוזרת לך לזכור, לתכנן ולטפל בדברים הקטנים שממלאים את הראש.',
  },
    ...
    <ScreenShell centered>
      <div className="flex w-full max-w-sm flex-col items-center gap-6 text-center">
        <div className="space-y-3">
          <p className="text-xs font-semibold tracking-[0.08em] text-primary">קצת יותר מקום לנשום</p>
